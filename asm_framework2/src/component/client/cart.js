                ...
                <table className="cart-table">
                  ...
                  <tbody>
                    <tr className="table-body-row">
                      ...
                      <td className="product-image"><img src={product1} alt="" /></td>
                    ...
                    <tr className="table-body-row">
                      <td className="product-remove"><a href="#"><i className="far fa-window-close"></i></a></td>
                      <td className="product-image"><img src={product2} alt="" /></td>
                    ...
                    <tr className="table-body-row">
                      <td className="product-remove"><a href="#"><i className="far fa-window-close"></i></a></td>
                      <td className="product-image"><img src={product3} alt="" /></td>
